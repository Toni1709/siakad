    ...
    <div class="ps-3">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb mb-0 p-0">
                ...
                <li class="breadcrumb-item active" aria-current="page">Revisi Laporan KKI</li>
            </ol>
        </nav>
    </div>
</div>
                    ...
                    <tbody>
                        @foreach ($laporan as $no => $l)
                            <tr>
                                ...
                                <td>{{ $l->nama_kelas }}</td>
                                <td>
                                    <a href="/berkas/revisi_laporan/hapus/{{ $l->id_rl }}" class="btn btn-sm btn-danger">Delete</a>
                                </td>
                            </tr>
                        @endforeach
                    </tbody>
