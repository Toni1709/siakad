...
<div class="page-breadcrumb d-flex d-sm-flex align-items-center mb-3">
    <div class="breadcrumb-title pe-1">Jenis Buku</div>
    {{-- <div class="ps-3">
                        ...
                        @foreach ($jenis as $no => $j)
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="/jenis_buku/hapus/{{ $id }}" class="btn btn-sm btn-danger">Delete</a>
                                </td>
                            </tr>
                        @endforeach
                    </tbody>
...
<div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="/jenis_buku/tambah" method="post">
                @csrf
    ...
    <div class="modal fade" id="exampleModal{{ $id }}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form action="/jenis_buku/edit" method="post">
                    @csrf
                    <div class="modal-body">
                        <div class="form-group">
                            <label for="">Jenis Buku</label>
                            <input type="hidden" name="id" value="{{ $id }}">
                            <input type="text" name="jenis" value="{{ $j->jenis_buku }}" class="form-control">
                        </div>
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
