        ...
        <div class="card border-top border-0 border-4 border-white">
            <div class="card-body">
                <div class="border p-4 rounded">
                    ...
                    <hr/>
                    <form action="/keanggotaan/edit" method="post" enctype="multipart/form-data">
                        @csrf
                        <div class="row mb-3">
                            <label for="inputChoosePassword2" class="col-sm-3 col-form-label">Mahasiswa</label>
                            <div class="col-sm-9">
                                <input type="text" name="id" value="{{ $anggota->id_anggota }}" readonly class="form-control">
                            </div>
                        </div>
                        <div class="row mb-3">
                            <label for="inputChoosePassword2" class="col-sm-3 col-form-label">Mahasiswa</label>
                            <div class="col-sm-9">
                                <select name="id_mahasiswa" class="single-select">
                                    ...
                                    @foreach ($mahasiswa as $m)
                                        <option value="{{ $m->id }}" {{ $m->id == $anggota->id_mahasiswa ? 'selected' : '' }}>
