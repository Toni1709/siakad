...
<div class="page-breadcrumb d-flex d-sm-flex align-items-center mb-3">
    <div class="breadcrumb-title pe-1">Data Tagihan</div>
    {{-- <div class="ps-3">
        ...
        <div class="card">
            ...
            <div class="card-body table-responsive">
                <table class="table mb-0">
                    ...
                    <tbody>
                        @foreach ($uang as $no => $u)
                            <tr>
                                <td>{{ $no+1 }}</td>
                                <td>{{ $u->angkatan }}</td>
                                <td>{{ $u->tahun_akademik }}</td>
                                <td>{{ $u->uang_semester }}</td>
                                <td>
                                    <a href="/master/tagihan/hapus/{{ $u->id_uangs }}" class="btn btn-sm btn-danger">Delete</a>
                                </td>
                            </tr>
                        @endforeach
                    </tbody>
...
<div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="/master/tagihan/tambah" method="post">
                @csrf
