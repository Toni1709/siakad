            ...
            <div class="card-body">
                <div class="border p-4 rounded">
                    <div class="card-title d-flex align-items-center">
                        ...
                        <h5 class="mb-0 text-white">Form Upload Training Softskill</h5>
                    </div>
                    <hr/>
                    <form action="/kki/ts/input" method="post" enctype="multipart/form-data">
                        @csrf
                        <div class="row mb-3">
                        ...
                        <div class="row mb-3">
                            <label for="inputChoosePassword2" class="col-sm-3 col-form-label">TSS</label>
                            <div class="col-sm-9">
                                <select name="tss" id="" class="form-control">
                                    <option value="">-- Pilih TSS --</option>
                                    @for ($i = 1; $i <= 8; $i++)
                                        <option value="TSS{{ $i }}">TSS{{ $i }}</option>
                                    @endfor
                                </select>
                            </div>
                        </div>
                        <div class="row mb-3">
                            <label for="inputChoosePassword2" class="col-sm-3 col-form-label">File Sertifikat</label>
                            <div class="col-sm-9">
