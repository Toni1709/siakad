            ...
            <div class="card-body">
                <div class="border p-4 rounded">
                    <div class="card-title d-flex align-items-center">
                        ...
                        <h5 class="mb-0 text-white">Form Upload Nilai KKI</h5>
                    </div>
                    <hr/>
                    <form action="/kki/nilai/input" method="post" enctype="multipart/form-data">
                        @csrf
                        <div class="row mb-3">
                        ...
                        <div class="row mb-3">
                            <label for="inputChoosePassword2" class="col-sm-3 col-form-label">File Nilai KKI</label>
                            <div class="col-sm-9">
